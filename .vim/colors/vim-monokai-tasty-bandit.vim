...
let g:colors_name = "vim-monokai-tasty-bandit"
...
call Highlight("LineNr", s:grey, s:none, s:none)
call Highlight("VertSplit", s:dark_grey, s:dark_grey, s:none)
call Highlight("StatusLine", s:dark_grey, s:dark_grey, s:none)
call Highlight("StatusLineNC", s:light_grey, s:dark_grey, s:none)
...
call Highlight("NERDTreeClosable", s:purple, s:none, s:none)
call Highlight("NERDTreeOpenable", s:purple, s:none, s:none)
call Highlight("NERDTreeDirSlash", s:purple, s:none, s:none)
call Highlight("NERDTreeFile", s:white, s:none, s:none)

" Ruby
call Highlight("rubyStringDelimiter", s:yellow, s:none, s:none)

" Eruby
call Highlight("erubyDelimiter",  s:danger, s:light_charcoal, s:none)
call Highlight("erubyExpression", s:white, s:light_charcoal, s:none)
call Highlight("erubyComment",    s:grey, s:light_charcoal, s:none)
call Highlight("erubyConditional",    s:light_green, s:light_charcoal, s:none)

" HTML highlighting
call Highlight("htmlTag",            s:white, s:none, s:none)
call Highlight("htmlEndTag",         s:white, s:none, s:none)
call Highlight("htmlTagN",           s:danger, s:none, s:none)
call Highlight("htmlTagName",        s:danger, s:none, s:none)
call Highlight("htmlSpecialTagName", s:danger, s:none, s:none)
